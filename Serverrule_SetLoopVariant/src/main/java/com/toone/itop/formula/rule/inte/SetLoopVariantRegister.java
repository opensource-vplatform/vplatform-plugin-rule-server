 ...
 */
public class SetLoopVariantRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + SetLoopVariant.D_RULE_CODE;
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(SetLoopVariant.D_RULE_CODE)
                .setDesc(SetLoopVariant.D_RULE_DESC)
                .setName(SetLoopVariant.D_RULE_NAME)
                .setEntry(SetLoopVariant.class)
                ;
