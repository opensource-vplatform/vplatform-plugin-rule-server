 ...
 */
public class AbortRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + AbortLoop.D_RULE_CODE;
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(AbortLoop.D_RULE_CODE)
                .setDesc(AbortLoop.D_RULE_DESC)
                .setName(AbortLoop.D_RULE_NAME)
                .setEntry(AbortLoop.class)
                ;
