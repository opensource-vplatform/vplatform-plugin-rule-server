 ...
 */
public class CopyTableRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + CopyRecordBetweenTables.D_RULE_CODE; 
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(CopyRecordBetweenTables.D_RULE_CODE)
                .setDesc(CopyRecordBetweenTables.D_RULE_DESC)
                .setName(CopyRecordBetweenTables.D_RULE_NAME)
                .setEntry(CopyRecordBetweenTables.class)
                ;
