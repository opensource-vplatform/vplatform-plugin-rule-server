...
public class ModifyDataBaseRegister implements IRegisterPlugin {
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(ModifyDataBaseRecord.D_RULE_CODE)
                .setDesc(ModifyDataBaseRecord.D_RULE_DESC)
                .setName(ModifyDataBaseRecord.D_RULE_NAME)
                .setEntry(ModifyDataBaseRecord.class)
                ;
