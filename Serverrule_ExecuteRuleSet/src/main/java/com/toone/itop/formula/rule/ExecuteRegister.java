 ...
 */
public class ExecuteRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + ExecuteRuleSet.D_RULE_CODE; 
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(ExecuteRuleSet.D_RULE_CODE)
                .setDesc(ExecuteRuleSet.D_RULE_DESC)
                .setName(ExecuteRuleSet.D_RULE_NAME)
                .setEntry(ExecuteRuleSet.class)
                ;
