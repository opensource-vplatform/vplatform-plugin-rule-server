...
public class AbortRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + AbortRule.D_RULE_CODE;
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(AbortRule.D_RULE_CODE)
                .setDesc(AbortRule.D_RULE_DESC)
                .setName(AbortRule.D_RULE_NAME)
                .setEntry(AbortRule.class)
                ;
