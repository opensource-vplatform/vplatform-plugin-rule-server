 ...
 */
public class ServPrintRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + ServPrintDataTrans.D_RULE_CODE; 
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(ServPrintDataTrans.D_RULE_CODE)
                .setDesc(ServPrintDataTrans.D_RULE_DESC)
                .setName(ServPrintDataTrans.D_RULE_NAME)
                .setEntry(ServPrintDataTrans.class)
                ;
