 ...
 */
public class ServerGenerateXMLOrJSONRegister implements IRegisterPlugin {
    ...
    public final static String D_RULE_CODE = "ServerGenerateXMLOrJSON";
    public final static String D_RULE_NAME = "配置数据生成";
    ...
    public final static String D_COMPONENT = "Serverrule_GenerateXMLOrJSON";
    ...
    private IPluginProfileVo getRuleProfile() {
        ...
        ruleBuilder.setAuthor(D_Author)
                ...
                .setDesc(D_RULE_DESC)
                .setName(D_RULE_NAME)
                .setEntry(ServerGenerateXMLOrJSON.class)
        ;
