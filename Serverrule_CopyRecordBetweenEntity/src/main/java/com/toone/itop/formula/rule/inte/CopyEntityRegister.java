 ...
 */
public class CopyEntityRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + CopyRecordBetweenEntity.D_RULE_CODE; 
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(CopyRecordBetweenEntity.D_RULE_CODE)
                .setDesc(CopyRecordBetweenEntity.D_RULE_DESC)
                .setName(CopyRecordBetweenEntity.D_RULE_NAME)
                .setEntry(CopyRecordBetweenEntity.class)
                ;
