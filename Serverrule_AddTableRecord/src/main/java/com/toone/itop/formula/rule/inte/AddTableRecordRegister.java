 ...
 */
public class AddTableRecordRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + AddTableRecord.D_RULE_CODE;
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(AddTableRecord.D_RULE_CODE)
                .setDesc(AddTableRecord.D_RULE_DESC)
                .setName(AddTableRecord.D_RULE_NAME)
                .setEntry(AddTableRecord.class)
                ;
