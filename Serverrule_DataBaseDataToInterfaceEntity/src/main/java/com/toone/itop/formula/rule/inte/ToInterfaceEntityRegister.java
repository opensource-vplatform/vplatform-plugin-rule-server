 ...
 */
public class ToInterfaceEntityRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + DataBaseDataToInterfaceEntity.D_RULE_CODE; 
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(DataBaseDataToInterfaceEntity.D_RULE_CODE)
                .setDesc(DataBaseDataToInterfaceEntity.D_RULE_DESC)
                .setName(DataBaseDataToInterfaceEntity.D_RULE_NAME)
                .setEntry(DataBaseDataToInterfaceEntity.class)
                ;
