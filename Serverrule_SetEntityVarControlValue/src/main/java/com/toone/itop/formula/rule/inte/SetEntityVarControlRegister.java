 ...
 */
public class SetEntityVarControlRegister implements IRegisterPlugin {
	public static final String D_COMPONENT="Serverrule_" + SetEntityVarControlValue.D_RULE_CODE;
	/** 插件作者 */
    ...
    private IRuleProfileVo getRuleProfile() {
    	...
    	ruleBuilder.setAuthor(D_Author)
                .setCode(SetEntityVarControlValue.D_RULE_CODE)
                .setDesc(SetEntityVarControlValue.D_RULE_DESC)
                .setName(SetEntityVarControlValue.D_RULE_NAME)
                .setEntry(SetEntityVarControlValue.class)
                ;
